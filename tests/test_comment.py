...
class CommentTest(unittest.TestCase):
    ...
    '''
    def setUp(self):
        self.user_Larvine = User(username = 'Larvine',password = 'monkey', email = 'larv@mkey.com')
        self.new_comment = Comment(pitch_id=12345,pitch_title='Review for movies',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",movie_review='This movie is the best thing since sliced bread',user = self.user_Larvine ) 
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_comment.user,self.user_Larvine) 
